...
CREATE DATABASE `ara-dz_newscrawl-OSIAN_2018_10K`;

USE `ara-dz_newscrawl-OSIAN_2018_10K`;
...
LOAD DATA LOCAL INFILE 'ara-dz_newscrawl-OSIAN_2018_10K-words.txt' INTO TABLE words CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'ara-dz_newscrawl-OSIAN_2018_10K-sentences.txt' INTO TABLE sentences CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'ara-dz_newscrawl-OSIAN_2018_10K-co_s.txt' INTO TABLE co_s CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'ara-dz_newscrawl-OSIAN_2018_10K-co_n.txt' INTO TABLE co_n CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'ara-dz_newscrawl-OSIAN_2018_10K-inv_w.txt' INTO TABLE inv_w CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'ara-dz_newscrawl-OSIAN_2018_10K-inv_so.txt' INTO TABLE inv_so CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'ara-dz_newscrawl-OSIAN_2018_10K-sources.txt' INTO TABLE sources CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'ara-dz_newscrawl-OSIAN_2018_10K-meta.txt' INTO TABLE meta CHARACTER SET utf8mb4;
